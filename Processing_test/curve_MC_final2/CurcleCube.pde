class CURCLECUBE //<>// //<>//
{
  ...
  void segset(int seg, int vnum, int hnum )
  {
    ...
    chek = new int[heigtNum][(numSegments*4)*CPnum+1][(numSegments)*4+1];
  }
  ...
  void setCube2(int hNum, int[][][]c)
  { //<>//
      for (int k=0; k<heigtNum; k++)
    {
  ...
  void SumfaceCubeChek(int numSegments)
  {
    PShape s;  
