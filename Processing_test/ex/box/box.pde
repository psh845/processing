...
for(int i=0; i<8; i++)
{
  normalizevertice[i][0] = (normalilze[1]-(normalilze[0]))*(vertices[i][0]-(wold[0]))/(wold[1]-(wold[0]))-1;
  normalizevertice[i][1] = (normalilze[3]-(normalilze[2]))*(vertices[i][1]-(wold[2]))/(wold[3]-(wold[2]))-1;
