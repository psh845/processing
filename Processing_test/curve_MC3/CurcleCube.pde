class CURCLECUBE //<>//
{
  ...
  void Position(FloatList x, FloatList y, FloatList z)
  {
    float a, b, c;
    //print(curve_x.get(0));
  ...
  {
    cap1( curve_normal.get(0), heigtNum);
    cap2( curve_normal.get(3*CPnum), heigtNum);
    if (hNum>1) {
